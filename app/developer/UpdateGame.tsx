...
const UpdateGame = () => {
  ...
  const handleUpdateGame = async () => {
    ...
    try {
      ...
      const response = await axios.post("/developer/updateGame", {
        id: game._id,
        name: gameName,
      ...
      setLogo(null);
      setHtmlFile(null);
      router.replace("/developer/Games");
    } catch (error) {
      console.error(error);
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.header}>Update Game</Text>
        ...
        {/* Add Game Button */}
        <TouchableOpacity style={styles.addButton} onPress={handleUpdateGame}>
